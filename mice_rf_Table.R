...
# Version: Article v1
#
# Purpose: This code creates a new table with the MICE Random Forest imputation
#          method for missing data and joins with covariates from the old table
#          then runs FENB tests
#
...
# Date: 2024-1-23
#
# File Name: mice_rf_Table.R
#
# Description: This file contains R code to create the MICERF table and run tests.
#
# Modifications:
#
# Changes:
...
#below we perform the imputation of "0" for "NA", because they are not real NAs, 
#given that Kaplan's db is a table of occurrences and our table has all periods
#below is necessary because this var cannot be NA since we have to add it later on to the occurrences
...
#we join with a db of arrests we had retrieved at a previous date since the API call above no longer works
...
#join arrests
JH_db_new_ct1 <- left_join(JH_db_new_ct1, Arrests_db_JH, by = "BREAKln")
...
n_occur <- data.frame(table(JH_db_new_ct1$BREAKln))

#which rows happened more than once
n_occur[n_occur$Freq > 1,]

#list dups
JH_db_new_ct1[JH_db_new_ct1$BREAKln %in% n_occur$Var1[n_occur$Freq > 1],]

#descriptive stats

#descriptive stats for CJH
Hmisc::describe(JH_db_new_ct1$cit_total_victims)
stat.desc(JH_db_new_ct1$cit_total_victims)
#percentage of zeroes for JH cit
sumCol <- JH_db_new_ct1$cit_total_victims
...
Hmisc::describe(JH_db_new_ct1$pol_total_victims)
stat.desc(JH_db_new_ct1$pol_total_victims)
#percentage of zeroes for JH pol
sumCol <- JH_db_new_ct1$pol_total_victims
sumCol <- as.data.frame(sumCol)
...
Hmisc::describe(JH_db_new_ct1$tot_JH_total_victims)
stat.desc(JH_db_new_ct1$tot_JH_total_victims)
#percentage of zeroes for JH tot
sumCol <- JH_db_new_ct1$tot_JH_total_victims
sumCol <- as.data.frame(sumCol)
...
Hmisc::describe(JH_db_new_ct1$syg_law)
stat.desc(JH_db_new_ct1$syg_law)
#percentage of zeroes for SYG LAW
sumCol <- JH_db_new_ct1$syg_law
sumCol <- as.data.frame(sumCol)
...
Hmisc::describe(JH_db_new_ct1$shall_issue)
stat.desc(JH_db_new_ct1$shall_issue)
#percentage of zeroes for RTC LAW
sumCol <- JH_db_new_ct1$shall_issue
sumCol <- as.data.frame(sumCol)
...
Hmisc::describe(JH_db_new_ct1$homs_total_victims)
stat.desc(JH_db_new_ct1$homs_total_victims)
#percentage of zeroes for log of murder rate
sumCol <- JH_db_new_ct1$homs_total_victims
sumCol <- as.data.frame(sumCol)
...
Hmisc::describe(JH_db_new_ct1$pop_20_39)
stat.desc(JH_db_new_ct1$pop_20_39)
#percentage of zeroes for population from 20 through 39 years
sumCol <- JH_db_new_ct1$pop_20_39
sumCol <- as.data.frame(sumCol)
...
Hmisc::describe(JH_db_new_ct1$popstate)
stat.desc(JH_db_new_ct1$popstate)
#percentage of zeroes for log of state population
sumCol <- JH_db_new_ct1$popstate
sumCol <- as.data.frame(sumCol)
...
Hmisc::describe(JH_db_new_ct1$police)
stat.desc(JH_db_new_ct1$police)
#percentage of zeroes for log of police rate
sumCol <- JH_db_new_ct1$police
sumCol <- as.data.frame(sumCol)
...
Hmisc::describe(JH_db_new_ct1$poverty_rate)
stat.desc(JH_db_new_ct1$poverty_rate)
#percentage of zeroes for poverty rate
sumCol <- JH_db_new_ct1$poverty_rate
sumCol <- as.data.frame(sumCol)
...
Hmisc::describe(JH_db_new_ct1$unemp_rate)
stat.desc(JH_db_new_ct1$unemp_rate)
#percentage of zeroes for unemployment rate
sumCol <- JH_db_new_ct1$unemp_rate
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for RTC LAW
Hmisc::describe(JH_db_new_ct1$arrests)
stat.desc(JH_db_new_ct1$arrests)
#percentage of zeroes for RTC LAW
sumCol <- JH_db_new_ct1$arrests
sumCol <- as.data.frame(sumCol)
...
###################
#below we run mice RF imputation
...
#save a copy
#write.csv(JH_db_new_ct1, "C:/JH_Oct_RFimput_dirty.csv", row.names=FALSE)
...
#descriptive stats for CJH
Hmisc::describe(JH_db_new_ct1$cit_total_victims_imp)
stat.desc(JH_db_new_ct1$cit_total_victims_imp)
#percentage of zeroes for JH cit
sumCol <- JH_db_new_ct1$cit_total_victims_imp
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for PJH
Hmisc::describe(JH_db_new_ct1$pol_total_victims_imp)
stat.desc(JH_db_new_ct1$pol_total_victims_imp)
#percentage of zeroes for JH pol
sumCol <- JH_db_new_ct1$pol_total_victims_imp
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for TJH
Hmisc::describe(JH_db_new_ct1$tot_JH_total_victims_imp)
stat.desc(JH_db_new_ct1$tot_JH_total_victims_imp)
#percentage of zeroes for JH tot
sumCol <- JH_db_new_ct1$tot_JH_total_victims_imp
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for log of murder rate
Hmisc::describe(JH_db_new_ct1$homs_total_victims_imp)
stat.desc(JH_db_new_ct1$homs_total_victims_imp)
#percentage of zeroes for log of murder rate
sumCol <- JH_db_new_ct1$homs_total_victims_imp
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for population from 20 through 39 years
Hmisc::describe(JH_db_new_ct1$pop_20_39_imp)
stat.desc(JH_db_new_ct1$pop_20_39_imp)
#percentage of zeroes for population from 20 through 39 years
sumCol <- JH_db_new_ct1$pop_20_39_imp
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for log of state population
Hmisc::describe(JH_db_new_ct1$popstate_imp)
stat.desc(JH_db_new_ct1$popstate_imp)
#percentage of zeroes for log of state population
sumCol <- JH_db_new_ct1$popstate_imp
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for log of police rate
Hmisc::describe(JH_db_new_ct1$police_imp)
stat.desc(JH_db_new_ct1$police_imp)
#percentage of zeroes for log of police rate
sumCol <- JH_db_new_ct1$police_imp
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for poverty rate
Hmisc::describe(JH_db_new_ct1$poverty_rate_imp)
stat.desc(JH_db_new_ct1$poverty_rate_imp)
#percentage of zeroes for poverty rate
sumCol <- JH_db_new_ct1$poverty_rate_imp
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for unemployment rate
Hmisc::describe(JH_db_new_ct1$unemp_rate_imp)
stat.desc(JH_db_new_ct1$unemp_rate_imp)
#percentage of zeroes for unemployment rate
sumCol <- JH_db_new_ct1$unemp_rate_imp
sumCol <- as.data.frame(sumCol)
...
#descriptive stats for RTC LAW
Hmisc::describe(JH_db_new_ct1$arrests_imp)
stat.desc(JH_db_new_ct1$arrests_imp)
#percentage of zeroes for RTC LAW
sumCol <- JH_db_new_ct1$arrests_imp
sumCol <- as.data.frame(sumCol)
...
#write.csv(JH_db_June, "C:/JH_Oct_RFimput_cleaner.csv", row.names=FALSE)


#load tables created with MICE RF algorithm
JH_db_July <- read_csv('C:/JH_Oct_RFimput_cleaner.csv')
...
#write.csv(JH_db_final_September, "C:/JH_Sept_dirty.csv", row.names=FALSE)
...
#write.csv(JH_db_final_September, "C:/JH_Oct_clean.csv", row.names=FALSE)



#load tables created with MICE RF algorithm
JH_db_final_September <- read_csv('C:/JH_Oct_clean.csv')
...
n_occur <- data.frame(table(JH_db_final_September$BREAKln))

#which rows happened more than once
n_occur[n_occur$Freq > 1,]

#list dups
JH_db_final_September[JH_db_final_September$BREAKln %in% n_occur$Var1[n_occur$Freq > 1],]

#remove dups
JH_db_final_September <- JH_db_final_September %>% distinct(BREAKln, .keep_all = TRUE)
...
#hausman test
fixed <- plm(model_cit, data=JH_db_final_September[which(!is.na(JH_db_final_September$state)), ], index=c("state", "year"), model="within")  #fixed model
random <- plm(model_cit, data=JH_db_final_September[which(!is.na(JH_db_final_September$state)), ], index=c("state", "year"), model="random")  #random model
...
#citizen test
#random
model_cit <- JH_cit_imp ~ shall_issue + syg_law + unemp_rate_imp + log_murder_rate_imp + log_police_rate_imp + log_arrest_rate_imp + poverty_rate_imp + log_popstate_imp
...
#random
model_cit_test <- JH_cit_imp ~ shall_issue + syg_law + unemp_rate_imp + log_murder_rate_imp + log_police_rate_imp + log_arrest_rate_imp + poverty_rate_imp + log_popstate_imp + pop_20_39_imp
...
#police test
#random
model_pol <- JH_pol_imp ~ shall_issue + syg_law + unemp_rate_imp + log_murder_rate_imp + log_police_rate_imp + log_arrest_rate_imp + poverty_rate_imp + log_popstate_imp
...
#random
model_pol_test <- JH_pol_imp ~ shall_issue + syg_law + unemp_rate_imp + log_murder_rate_imp + log_police_rate_imp + log_arrest_rate_imp + poverty_rate_imp + log_popstate_imp + pop_20_39_imp
...
#total test
#random
model_tot <- JH_tot_imp ~ shall_issue + syg_law + unemp_rate_imp + log_murder_rate_imp + log_police_rate_imp + log_arrest_rate_imp + poverty_rate_imp + log_popstate_imp
...
#random
model_tot_test <- JH_tot_imp ~ shall_issue + syg_law + unemp_rate_imp + log_murder_rate_imp + log_police_rate_imp + log_arrest_rate_imp + poverty_rate_imp + log_popstate_imp + pop_20_39_imp
