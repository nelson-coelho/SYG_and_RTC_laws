...
#load regular tables 
JH_db_reg_diversecrimes <- read_csv('C:/JH_Oct_with_LEOKA.csv')

#load tables created with MICE RF algorithm
JH_db_MICERF_diversecrimes <- read_csv('C:/JH_Oct_clean.csv')

#load table that has all crimes by state
estimated_crimes_1979_2023 <- read_csv('C:/estimated_crimes_1979_2023.csv')
...
#save tables
write.csv(JH_all_crimes_regular, "C:/JH_all_crimes_regular.csv", row.names=FALSE)
write.csv(JH_all_crimes_MICERF, "C:/JH_all_crimes_MICERF.csv", row.names=FALSE)
