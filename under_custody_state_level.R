...
# Date: 2025-2-08
#
# File Name: under_custody_state_level.R
#
...
#because our variable of interest (CUSTOTT = total of prisoners in custody)
#has differing columns depending on the year, we split our db into two
#then rename the focus variable and rejoin

#removing years not kept in each iteration
...
#cleaning and adding a variable that is used to join tables
